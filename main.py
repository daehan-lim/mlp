...
@utilities.timeit
def main():
    training_set = pd.read_csv("data/training_set_binary_norm.csv")
    test_set = pd.read_csv("data/test_set_binary_norm.csv")
    ...
    params = { # 'activation': ['relu', 'tanh', 'logistic'],
              'hidden_layer_sizes': [(1024, 512, 256), (64, 32), (128, 64, 32), (128, 64), (256, 128), (512, 256), (1024, 512)],
              # 'max_iter': [50, 200, 400],
              # 'solver': ['adam', 'sgd',],
    ...
    clf = MLPClassifier(random_state=1, max_iter=400, learning_rate_init=0.01, activation='logistic')
